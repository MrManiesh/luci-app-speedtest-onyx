...
return view.extend({
    ...
    speedToFraction: function(mbps) {
        ...
        if (mbps <= 10) return (mbps / 10) * 0.12;
        if (mbps <= 50) return 0.12 + ((mbps - 10) / 40) * 0.18;
        if (mbps <= 100) return 0.30 + ((mbps - 50) / 50) * 0.20;
        if (mbps <= 250) return 0.50 + ((mbps - 100) / 150) * 0.22;
        if (mbps <= 500) return 0.72 + ((mbps - 250) / 250) * 0.16;
        if (mbps <= 1000) return 0.88 + ((mbps - 500) / 500) * 0.12;
        return 1.0;
    },
    ...
    render: function(data) {
        ...
        gaugeSvg.innerHTML = 
            ...
            '<text x="60" y="232" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">0</text>' +
            '<text x="45" y="150" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">25</text>' +
            '<text x="75" y="75" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">100</text>' +
            '<text x="140" y="45" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">250</text>' +
            '<text x="205" y="75" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">500</text>' +
            '<text x="235" y="150" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">750</text>' +
            '<text x="220" y="232" fill="#64748b" font-size="11" font-weight="600" text-anchor="middle">1G</text>' +
        ...
        var readoutBox = E('div', {
            ...
            E('div', {
                'id': 'st-gauge-unit',
                'style': 'font-size:13px;font-weight:700;color:#38bdf8;letter-spacing:1px;text-transform:uppercase;margin-top:4px;'
            }, 'Mbps'),
            E('div', {
                'id': 'st-gauge-phase',
